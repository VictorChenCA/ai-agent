# CS 153 - QuizAI
Our final project is an agent to help with flashcard based studying -- simply put, we aimed to emulate the experience of going over flashcards with a knowledgable (and patient!) partner. Our agent is accessible through the QuizAI discord channel, and its very easy to get started. Simply send over a list of terms, and our agent will question you and talk through what the correct reasoning was. At the end, you'll be presented with a paired list of your terms with the flashcards that the agent created. While regular flashcards promote rote memorization, we have built our agent to prompt critical thinking in the response to each quesion. 
